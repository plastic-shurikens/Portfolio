                ...
                <div className="elements">
                    {!isSubmitted ? (
                     <>
                       ...
                       <form onSubmit={handleSubmit} className='form' noValidate ref={form}>
                        <h1>Send a message</h1>

                          <div className='form-inputs'>
                              <label className='form-label'>Name :</label>
                              <input className='form-input' type='text' name='name' placeholder='Enter your name' value={values.username} onChange={handleChange} />
                          ...
                          <div className='form-inputs'>
                            ...
                            <textarea className='form-input message' name='message' placeholder='Enter your message' value={values.message} onChange={handleChange} />
